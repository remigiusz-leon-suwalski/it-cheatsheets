...
\definecolor{rubycolor}{HTML}{daffeb}
\BeforeBeginEnvironment{minted}{\begin{tcolorbox}[breakable,boxsep=1pt,left=1pt,right=2pt,top=0pt,bottom=0pt,boxrule=0.5pt,arc=0pt,outer arc=0pt,colback=rubycolor,colframe=rubycolor]}%
